...
export default function MaterialThickness({
  ...
  function updatePlate(plateId: string, field: keyof Plate, value: number) {
    setPlates((prev) =>
      prev.map((p) => (p.id === plateId ? { ...p, [field]: value } : p))
    );
  }
  ...
  function formValid() {
    return (
      plates.every(
        (plate) => plate.Length > 0 && plate.Width > 0 && plate.trueDepth > 0
  ...
  return (
    <div className="row">
      <div className="col-md-4">
        <div className="card gh-box mb-3">
          <div className="card-body">
            ...
            <div className="text-white-50">
              <strong>Thickness:</strong> {session.thickness}
            </div>
            <form
              method="post"
              action={`/mt/${encodeURIComponent(
                session.material
              )}/${encodeURIComponent(session.thickness)}/auto_breakdown`}
              className="mt-3"
            >
              ...
              <button className="btn btn-primary" disabled>
                Request Auto Breakdown
              </button>
              <div className="form-text mt-2 text-danger">
                Select at least one part and add at least one plate to proceed.
              </div>
              <div className="form-text small text-white-50">
                Last updated: <span>{session.updatedAt}</span>
              </div>
            </form>
          </div>
        </div>
                      ...
                      <div className="row g-2">
                        <div className="col-4">
                          ...
                          <input
                            ...
                            step="0.01"
                            min="0"
                            className="form-control text-white form-control-sm gh-input"
                            value={plate.Width}
                            onChange={(e) =>
                              updatePlate(
                                plate.id,
                        ...
                        <div className="col-4">
                          ...
                          <input
                            ...
                            step="0.001"
                            min="0"
                            className="form-control form-control-sm gh-input text-white"
                            value={plate.trueDepth}
                            onChange={(e) =>
                              updatePlate(
                                plate.id,
                                "trueDepth",
      ...
      <div className="col-md-8">
        <div className="card gh-box mb-3">
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <button
                className="btn btn-sm btn-outline-primary"
                onClick={() => setQuantities(selectAllQuantities())}
              >
                        ...
                        {parts.map((part) => (
                          ...
                          >
                            <div>
                              ...
                              <div className="small text-white-50">
                                Recommended: {part.quantity} • Available:{" "}
                                {part.available} • ID: {part.id}
                              </div>
                            </div>
                            <div className="d-flex align-items-center gap-2">
                              <div
                              ...
                              >
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateQuantity(part, e.target.valueAsNumber)
                                  }
                                />
                                <button
                                  className="btn btn-outline-primary"
        ...
        <div
          className="card gh-box"
          id="assignCard"
          style={{ display: formValid() ? "" : "none" }}
        >
          <div className="card-body">
            <div className="d-flex justify-content-between align-items-center mb-2">
              ...
              <div className="col-lg-4">
                <div className="gh-box p-2">
                  ...
                  <ul
                    ...
                    className="list-group list-group-flush min-vh-25"
                      ...
                      >
                        ...
                        <form>
                          <div className="d-flex align-items-center gap-2">
                            <select
                              name="machine"
                              className="form-select form-select-sm text-white gh-input d-inline w-auto"
                            >
